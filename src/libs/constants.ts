...
export const MessageInfo = {
    ...
    MI_INVALID_PHONE_NUMBER: "Phone number is not valid.",
    ...
    MI_STORE_NOT_FOUND: "Store ID doesn’t exists.",
    MI_CATEGORY_NOT_EXIST : "Category doesn’t exist.",
    MI_INVALID_CATEGORY_NAME : "Category name is required.",
    MI_INVALID_PARENT_CATEGORY : "Category doesn’t exists.",
    SUBMITTED_FOR_APPROVAL: "Thank you. Your approval is in progress.",
    MI_DATA_SAVED_SUCCESSFULLY: "Data saved successfully.",
    MI_LOGISTICS_TYPE_ERROR: "Please select logistics.",
    MI_INVALID_INPUT: "Invalid input.",
    MI_STORE_SCHEME_TYPE_ID_NOT_FOUND: "Scheme doesn’t exists.",
    MI_SCHEME_NAME_NOT_EMPTY: "Scheme name is required.",
    MI_DURATION_NOT_EMPTY: "Please select duration.",
    MI_COMMISSION_B2B_NOT_EMPTY: "B2B commission is required.",
    MI_COMMISSION_B2C_NOT_EMPTY: "B2C commission is required.",
    MI_VALIDITY_NOT_EMPTY: "Please select validity.",
    MI_MEMBERSHIP_PRICE_NOT_EMPTY: "Membership price is required.",
    MI_LOGISTICS_TYPE_NOT_EMPTY: "Logistics type is required.",
    MI_SUBMITTED_FOR_APPROVAL: "Thank you. Your approval is in progress.",
    MI_APPROVAL_NOT_FOUND: "Approval request doesn’t exists.",
    MI_DOCUEMNT_TYPE_NOT_FOUND: "Document type doesn’t exists.",
    MI_MERCHANT_APPROVED_SUCCESSFULL: "Merchant approved successfully.",
    MI_CERTIFICATE_NAME_NOT_FOUND: "Certificate type name is required.",
    MI_STATUS_NOT_EMPTY: "Please select status.",
    MI_STATUS_ERROR: "Status can be Active or Inactive.",
    MI_STORE_CERTIFICATE_TYPE_ID_NOT_FOUND: "Store certificate doesn’t exists.",
    MI_CERTIFICATE_REQUIRED_STATUS: "Please select status.",
    MI_REQUIRED_VALIDATION: "Status should be active or inactive.",
    MI_DOCUMENT_TYPE_NAME_NOT_EMPTY: "Document type name is required.",
    MI_DOCUMENT_TYPE_ID_NOT_FOUND: "Document type not found.",
    MI_PERMISSION_NAME_NOT_EMPTY : "Permission is required.",
    MI_MERCHANT_STATUS_UPDATED_SUCCESSFULL: "Merchant status updated.",
    MI_PERMISSION_TYPE_NOT_EMPTY:"Permission can be active or inactive.",
    MI_USER_NOT_ACTIVE:"User is not active.",
    MI_ASSIGNED_ROLE_NOT_FOUND:"Assigned role is not found.",
    ...
    MI_CATEGORY_REQUEST_ADDED:"Category added successfully.",
    MI_CATEGORY_APPROVED:"Category approved successfully.",
    ...
    MI_DOCUMENT_TYPE_NAME_IS_DUPLICATE: "Document name should be unique.",
    MI_ADMIN_APPROVAL_APPROVED_ACTION: "Approved successfully",
    MI_ADMIN_APPROVAL_REJECT_ACTION: "Rejected successfully",
    ...
    MI_USER_CREATION_FAILED: "User creation failed",
    MI_PHONE_NUMBER_NOT_EMPTY: "Phone number is required",
    MI_PHONE_NUMBER_NOT_EXIST: "Phone number is not exist",
    MI_PHONE_NUMBER_NOT_VALID: "Phone number is not valid",
    MI_PHONE_NUMBER_ALREADY_USE: "Phone number is already use",
    MI_OTP_ALREADY_SEND: "Otp already send",
    MI_PASSWORD_NOT_EMPTY: "Password is not empty",
    MI_EMAIL_OR_PHONE_NUMBER_REQUIRED: "Email or Phone number is required.",
    MI_STANDARD_ALREADY_EXISTS: "Standard already exists.",
    MI_STANDARD_NOT_FOUND: "Standard not found.",
    MI_SUBJECT_ALREADY_EXISTS: "Subject already exists.",
    MI_SUBJECT_NOT_FOUND: "Subject not found.",
    MI_SECTION_NAME_ALREADY_EXISTS: "Section name already exists.",
    MI_SECTION_NOT_FOUND: "Section not found.",
    MI_CLASS_NOT_FOUND: "Class name not found.",
    MI_CLASS_NAME_ALREADY_EXISTS: "Class name already exists.",
    MI_SUBJECT_ASSSINEE_IDS_NOT_FOUND: "Subject assignee id not found.",
    MI_HOME_WORK_DATE_NOT_FOUND: "Home work date not found.",
    MI_HOME_WORK_SUBMISSION_DATE_NOT_FOUND: "Home work submission date not found.",
    MI_MARKS_NOT_FOUND: "Marks not found.",
    MI_HOME_WORK_NOT_FOUND: "Home work not found.",
    MI_STUDENT_NOT_FOUND: "Student not found.",
    MI_STUDENT_OR_HOMEWORK_NOT_FOUND: "Student or homework not found.",
    MI_EXAM_TYPE_ALREADY_EXISTS: "Exam type already exists.",
    MI_EXAM_TYPE_NOT_FOUND: "Exam type not found.",
    MI_EXAM_START_DATE_NOT_FOUND: "Exam start date not found.",
    MI_EXAM_END_DATE_NOT_FOUND: "Exam end date not found.",
    MI_EXAM_START_TIME_NOT_FOUND: "Exam start time not found.",
    MI_EXAM_NOT_FOUND: "Exam not found.",
    MI_TOTAL_MARKS_REQUIRED: "Total marks required.",
    MI_CHECK_CLASS_EXIST: "Please check class is exist",
    MI_ATTENDANCE_NOT_FOUND: "Attendance not found.",
    MI_FEES_TYPE_NOT_FOUND: "Fees type not found.",
    MI_FEES_TYPE_ALREADY_EXISTS: "Fees type already exists.",
    MI_FEES_CATEGORY_NOT_FOUND: "Fees category not found.",
    MI_FEES_OPTION_NOT_FOUND: "Fees option not found.",
    MI_FEES_NOT_FOUND: "Fees not found.",
    MI_EXAM_DATE_NOT_FOUND: "Exam date not found.",
    MI_LESSON_NOT_FOUND: "Lesson not found.",
    MI_LESSIONS_ALREADY_EXISTS: "Lessons already exists.",
    MI_LESSONS_NOT_FOUND: "Lesson not found.",
    MI_TEACHER_NOT_FOUND: "Can not find teacher assigned to this subject.",
    MI_SYLLABUS_NOT_FOUND: "Syllabus not found.",
    MI_SYLLABUS_ALREADY_EXISTS: "Syllabus already exists.",
    MI_BUS_ALREADY_EXISTS: "Bus name already exists.",
    MI_BUS_NOT_FOUND: "Bus not found.",
    MI_BUS_NAME_REQUIRED: "Bus name required.",
    MI_BUS_NUMBER_REQUIRED: "Bus number required.",
    MI_LAT_NOT_FOUND: "Bus lat not found.",
    MI_LANG_NOT_FOUND: "Bus lang not found.",
    MI_EBOOKS_NOT_FOUND: "Ebooks not found.",
    MI_EBOOK_CREATION_FAILED: "Ebook creation failed.",
    MI_UPLOAD_PDF: "Please upload pdf file.",    
};
